...
public class correction_birth_apply extends AppCompatActivity {
    StorageReference mstorage;
    ImageView proof;
    FirebaseUser currentFirebaseUser = FirebaseAuth.getInstance().getCurrentUser() ;

    DatabaseReference md= FirebaseDatabase.getInstance().getReference().child("users").child("correction").child(currentFirebaseUser.getUid());
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correction_birth_apply);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(correction_birth_apply.this,correction_final.class);
        ...
        if(requestCode==GALLERY_INTENT && resultCode==RESULT_OK)
        {
            ...
            filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(correction_birth_apply.this,"upload done",Toast.LENGTH_LONG).show();
                }
            });
        }
